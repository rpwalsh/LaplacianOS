//! LaplacianOS terminal emulator.
//!
//! Minimal VT100-subset terminal that renders into a laplacianos-app-sdk surface.
//! LaplacianOS Terminal — Phase J complete implementation.
//!
...
//! - Phase J window chrome via laplacianos-app-sdk
...
use laplacianos_ui_sdk::widgets::{draw_notification_toast, draw_tab_bar};
...
fn main() {
    ...
    {
        let banner = b"\x1b[1;34mLaplacianOS Terminal\x1b[0m  xterm-256color  Phase J\r\n\
                ...
                Event::Key {
                    ...
                    match ascii {
                        ...
                        0x16 => {
                            ...
                            let n = unsafe { laplacianos_app_sdk::sys::clipboard_read(&mut clip) };
                            if n > 0 {
