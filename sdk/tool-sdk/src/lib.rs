//! LaplacianOS Tool SDK — build helpers, manifest schema, signing utilities.
//!
...
pub struct PackageManifest {
    /// Package name (e.g. "laplacianos-terminal").
    pub name: String,
...
/// LaplacianOS SDK. Only the first 32 bytes are required by Ed25519; the trailing
