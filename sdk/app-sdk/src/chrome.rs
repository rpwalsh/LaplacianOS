...
//! ## Integration
//! ```no_run
//! use laplacianos_app_sdk::chrome::{ChromeConfig, ChromeRenderer, TITLEBAR_HEIGHT};
//!
//! let width = 640_u32;
//! let stride = width as usize;
//! let mut buf = vec![0_u32; stride * TITLEBAR_HEIGHT as usize];
//! let mut renderer = ChromeRenderer::new(ChromeConfig::default());
//! renderer.draw_titlebar(&mut buf, stride, width, true);
//! renderer.draw_buttons(&mut buf, stride, width, 3, 3);
//! ```
