//! Spring-physics animation for ring-3 LaplacianOS applications.
//!
//! A critically-damped spring is the backbone of most LaplacianOS UI transitions.
...
//! # Usage
//! ```no_run
//! use laplacianos_app_sdk::animation::Spring;
//!
