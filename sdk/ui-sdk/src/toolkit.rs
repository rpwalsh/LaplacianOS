//! Minimal toolkit contract (LaplacianOS GTK-equivalent).
//!
//! This module intentionally exposes only essential primitives required by
//! LaplacianOS shell/apps and avoids a generic "widget zoo".
...
pub enum EssentialWidget {
    ...
    /// Toast/status strip.
    StatusToast = 11,
    /// LaplacianOS-native graph canvas.
    GraphView = 12,
    /// LaplacianOS-native timeline view.
    TimelineView = 13,
    /// LaplacianOS-native inspector view.
    InspectorView = 14,
}
