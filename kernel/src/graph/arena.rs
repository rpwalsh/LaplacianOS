...
//!
//! This is the core system abstraction of LaplacianOS. Every kernel object that
//! participates in scheduling, diagnostics, trust decisions, or review
...
//!
//! The arena stores the public LaplacianOS graph shape:
...
//! - **created_at**: boot-relative timestamp (sequence number until timer is online)
...
///
/// Type-filtered adjacency traversal for bounded graph inspection.
