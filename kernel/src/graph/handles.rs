...
//!
//! ## Typed-operator connection
//!
//! Typed message passing requires the source and destination `NodeKind` at
//! each transition. Handles preserve that identity without making claims
//! about a particular private transform or graph diagonalization.
...
/// Wired from bounded anomaly reporting.
#[inline]
