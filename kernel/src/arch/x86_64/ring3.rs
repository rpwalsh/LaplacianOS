...
global_asm!(
    r#"
    .global laplacianos_user_int80_entry
laplacianos_user_int80_entry:
    push rax
    push rbx
    push rcx
    push rdx
    ...
    .global laplacianos_user_syscall_entry
laplacianos_user_syscall_entry:
    swapgs
    ...
    sysretq
    "#,
    dispatch_int80 = sym laplacianos_dispatch_int80_syscall,
    dispatch_fast = sym laplacianos_dispatch_fast_syscall,
);

unsafe extern "C" {
    fn laplacianos_user_int80_entry();
    fn laplacianos_user_syscall_entry();
}

pub fn int80_entry_addr() -> u64 {
    laplacianos_user_int80_entry as *const () as u64
}

pub fn syscall_entry_addr() -> u64 {
    laplacianos_user_syscall_entry as *const () as u64
}
...
#[unsafe(no_mangle)]
extern "C" fn laplacianos_dispatch_int80_syscall(frame: &mut Int80Frame) -> u64 {
    dispatch_common(
...
#[unsafe(no_mangle)]
extern "C" fn laplacianos_dispatch_fast_syscall(frame: &mut FastSyscallFrame) -> u64 {
    dispatch_common(
        frame.rax, frame.rdi, frame.rsi, frame.rdx, frame.r10, frame.r8, frame.r9,
    )
}
