...
//! - **Review metrics**: `GraphQuery::DriftReport` asks for bounded graph
//!   drift metrics. `DriftEntry` carries public metric deltas and trend.
...
pub struct NodeScore {
    ...
    /// From validated drift and anomaly metrics.
    pub risk: Weight,
    ...
    /// From temporal recency accounting.
    pub recency: Weight,
}
...
// ────────────────────────────────────────────────────────────────────
// Drift report — review metric types
// ────────────────────────────────────────────────────────────────────
