//! GPU backend trait and implementations for the LaplacianOS scene compositor.
//!
//! ## Backends
//!
...
//! | `NativeGpuBackend` | Planned | LaplacianOS-native GPU command path driven by LaplacianOS submit packets. |
//!
//! ## Backend selection
//!
//! `ActiveBackend::init()` selects the best LaplacianOS-supported backend at
...
fn apply_opacity(color: u32, opacity: u8) -> u32 {
    ...
    let a = (color >> 24) * opacity as u32 / 255;
