...
//!
//! This module exposes entity resolution and relation
...
/// Provisional Hamming-distance gate. This is not a percentage similarity;
/// deployments must calibrate it against labeled entity matches.
