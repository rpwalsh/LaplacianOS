...
const BUILTIN_DRIVERS: [DriverDesc; 8] = [
    DriverDesc {
        name: b"pl011-uart0",
        bus: BusType::Platform,
        vendor: 0,
    ...
    DriverDesc {
        name: b"arm-generic-timer",
        bus: BusType::Platform,
        vendor: 0,
        device: 0,
        irq: crate::arch::aarch64::timer::VIRTUAL_TIMER_IRQ as u8,
        probe: probe_boot_managed_platform,
        handle_irq: noop_platform_irq,
    },
    DriverDesc {
        name: b"virtio-rng0",
        bus: BusType::VirtioMmio,
        vendor: 0x1AF4,
        device: 4,
        irq: 0,
        probe: crate::arch::aarch64::virtio_mmio::probe_entropy_driver,
        handle_irq: noop_platform_irq,
    },
    DriverDesc {
        name: b"virtio-net0",
        ...
        device: 1,
        irq: 0,
        probe: crate::arch::aarch64::virtio_mmio::probe_network_driver,
        handle_irq: crate::arch::aarch64::virtio_mmio::acknowledge_network_interrupt,
    },
    DriverDesc {
        name: b"virtio-blk0",
        bus: BusType::VirtioMmio,
        ...
        device: 2,
        irq: 0,
        probe: crate::arch::aarch64::virtio_mmio::probe_block_driver,
        handle_irq: crate::arch::aarch64::virtio_mmio::acknowledge_block_interrupt,
    },
    DriverDesc {
        name: b"virtio-input0",
        bus: BusType::VirtioMmio,
        ...
        device: 18,
        irq: 0,
        probe: crate::arch::aarch64::virtio_mmio::probe_input_driver,
        handle_irq: crate::arch::aarch64::virtio_mmio::acknowledge_input_interrupt,
    },
    DriverDesc {
        name: b"virtio-gpu0",
        bus: BusType::VirtioMmio,
