...
pub fn probe_driver() -> ProbeResult {
    ...
    let dev = crate::arch::pci::find_device(INTEL_VENDOR, HDA_DEVICE_ICH9)
        .or_else(|| crate::arch::pci::find_device(INTEL_VENDOR, HDA_DEVICE_ICH6))
        .or_else(|| crate::arch::pci::find_device(INTEL_VENDOR, HDA_DEVICE_BROADWELL));
