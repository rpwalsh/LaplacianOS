#!/usr/bin/env pwsh
# LaplacianOS GL Conformance Triage Script
#
# Purpose: Run the laplacianos-gl test suite and map results to Khronos ES 3.0
...
Write-Host "Running laplacianos-gl test suite..." -ForegroundColor Cyan

$ManifestPath = Join-Path $WORKSPACE "laplacianos\sdk\gl-sdk\Cargo.toml"
