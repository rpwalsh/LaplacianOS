# LaplacianOS Icon Atlas Build Pipeline
#
...
# ─────────────────────────────────────────────────────────────────────────────
# UUID v5 derivation: SHA-1 of "laplacianos:icon:" + relative path, formatted as RFC 4122.
function New-IconUuid {
    param([string]$RelPath)
    $ns = [System.Text.Encoding]::UTF8.GetBytes("laplacianos:icon:$RelPath")
