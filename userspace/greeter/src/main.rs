//! laplacianos-greeter — lock screen and login greeter.
//!
...
//! - **Unlocked** — greeter dismisses and hands off to laplacianos-shell.
//!
//! # Security model
...
fn main() {
    eprintln!("[greeter] LaplacianOS greeter starting");
