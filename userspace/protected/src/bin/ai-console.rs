//! ai-console -- LaplacianOS graph-first AI cockpit.
//!
...
pub extern "C" fn _start() -> ! {
    ...
    loop {
        ...
        laplacianos_app_sdk::sys::yield_now();
    }
}
