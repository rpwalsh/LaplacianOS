//! calculator - LaplacianOS desktop calculator.
//!
...
fn draw(win: &mut Window, app: &Calculator) {
    ...
    draw_window_frame(&mut canvas, Rect::new(0, 0, WIN_W, WIN_H), b"LaplacianOS Calculator", THEME);
    ...
    let tw = laplacianos_app_sdk::canvas::Canvas::text_width(&app.display[..app.display_len]);
