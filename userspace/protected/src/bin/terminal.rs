//! terminal - LaplacianOS built-in developer shell.
//!
//! Modern ring-3 terminal with:
//! - LaplacianOS shell chrome and quick-launch actions
...
impl Terminal {
    fn new() -> Self {
        ...
        term.push_line(b"LaplacianOS Terminal ready");
    ...
    fn cmd_uname(&mut self) {
        self.push_line(b"LaplacianOS x86_64 ring3");
    ...
    fn cmd_version(&mut self) {
        self.push_line(b"LaplacianOS developer shell");
    ...
    fn cmd_apps(&mut self) {
        ...
        self.push_line(b"Graph: graphd modeld trainerd artifactsd sysd services");
...
fn draw(win: &mut Window, term: &Terminal) {
    ...
    draw_window_frame(&mut canvas, root, b"LaplacianOS Terminal", THEME);
