//! paint - LaplacianOS sketch and markup tool.
//!
...
fn draw_canvas_pixels(canvas: &mut laplacianos_app_sdk::canvas::Canvas<'_>, app: &PaintApp) {
...
fn draw(win: &mut Window, app: &PaintApp) {
    ...
    draw_window_frame(&mut canvas, Rect::new(0, 0, WIN_W, WIN_H), b"LaplacianOS Paint", THEME);
