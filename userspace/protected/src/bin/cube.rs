//! Spinning cube demo rendered through the LaplacianOS GPU command path.
...
use laplacianos_app_sdk::event;
use laplacianos_app_sdk::sys as app_sys;
use laplacianos_app_sdk::window::Window;
use laplacianos_gfx::types::{BufferKind, DepthState, IndexFormat, RasterState, Topology, VertexLayout};
use laplacianos_gfx::{Color, CommandBuffer, GpuContext, GpuDevice, PixelFormat, ResourceId, ResourceKind};
use laplacianos_gl::math::{Mat4, Vec3};
