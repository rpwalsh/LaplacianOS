//! ssh — LaplacianOS SSH client stub.
//!
...
fn draw(win: &mut Window, s: &AppState) {
    ...
    c.draw_text(8, 5, b"LaplacianOS SSH Client", TITLE_TEXT, WIN_W - 16);
    ...
    let tw = laplacianos_app_sdk::canvas::Canvas::text_width(b"Connect");
