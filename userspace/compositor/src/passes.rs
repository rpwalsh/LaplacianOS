...
//! are encoded into LaplacianOS-native GPU commands and submitted in bulk.  Otherwise, the CPU
...
/// via `SYS_SURFACE_COMMIT` or submits a LaplacianOS-native GPU command buffer via
