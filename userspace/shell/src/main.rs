//! laplacianos-shell — the LaplacianOS desktop shell.
//!
//! # Responsibilities
//!
...
// IPC event loop stub
//
// In a real LaplacianOS process this would call SYS_CHANNEL_RECV in a loop.
...
fn main() {
    eprintln!("[laplacianos-shell] starting");
    ...
    state.push_notification(b"LaplacianOS shell ready");
    ...
    eprintln!("[laplacianos-shell] self-test passed — entering IPC wait loop");
